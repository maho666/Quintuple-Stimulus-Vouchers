...
int main()
{
    int good_price,pay_need,money=830;
    int money_value[] = {100,50,10,5,1};
    int remain_amount[] = {5,5,5,5,5};
    int paid_amount[] = {0,0,0,0,0};
    int money_paid[] = {0,0,0,0,0};
    ...
    good_price=0;
    int done = 0;
    float discount_type=1,discount_member=1;
    while(good_price<=0&&good_price != -1)
    {
